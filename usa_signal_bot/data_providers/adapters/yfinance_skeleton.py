...
class YFinanceProviderSkeleton(MarketDataProviderBase):
    ...
    def capabilities(self) -> list[DataProviderCapability]:
        return [
            ...
            DataProviderCapability.GET_INTRADAY_OHLCV,
            DataProviderCapability.GET_ADJUSTED_CLOSE,
            DataProviderCapability.GET_VOLUME,
            DataProviderCapability.GET_DIVIDENDS,
            DataProviderCapability.GET_SPLITS,
