...
class YFinanceMarketDataAdapter(MarketDataProviderBase):
    ...
    def fetch_daily_ohlcv_guarded(self, symbol: str, start_date: Optional[str] = None, end_date: Optional[str] = None, allow_network: bool = False) -> Dict[str, Any]:
        ...
        # Real fetch implementation would go here, but only if explicitly allowed and bypassed guards.
        # Still not returning real data for safety.
        return {
            "metadata_only": True,
            "provider": "YFINANCE",
            "network_used": False,
