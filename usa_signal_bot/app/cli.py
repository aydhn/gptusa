...
def handle_advanced_acceptance_commands(args, context):
    ...
    if args.command == "advanced-acceptance-info":
        print("Phase 159 is strictly an advanced acceptance rehearsal, release candidate audit and final freeze preparation phase.")
        print("It does NOT represent a deployment approval or trading approval.")
    elif args.command == "advanced-acceptance-review":
        from usa_signal_bot.release.advanced_acceptance_report import build_advanced_acceptance_context, build_advanced_acceptance_full_review, advanced_acceptance_full_review_to_text
        ...
        from usa_signal_bot.release.acceptance_scenario_matrix import build_acceptance_scenario_matrix, acceptance_scenario_matrix_to_text
        ...
        from usa_signal_bot.release.advanced_dry_run_rehearsal_executor import execute_advanced_dry_run_scenario_matrix, advanced_dry_run_rehearsal_to_text
        mat = build_acceptance_scenario_matrix()
