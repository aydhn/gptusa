...
path1 = "usa_signal_bot/paper_mode_dry_admission_dossier/dry_admission_gate_ingestion.py"
...
path2 = "usa_signal_bot/paper_mode_dry_admission_dossier/eligibility_checker.py"
...
def evaluate_dry_admission_dossier_eligibility(payload: dict[str, Any]) -> DryAdmissionDossierDecision:
    ...
    if DryAdmissionDossierRiskFlag.ACTIVATION_ALLOWED_RISK in flags or \
       DryAdmissionDossierRiskFlag.ADMISSION_ALLOWED_RISK in flags or \
       DryAdmissionDossierRiskFlag.TRANSITION_ALLOWED_RISK in flags or \
       DryAdmissionDossierRiskFlag.SHADOW_LAUNCH_RISK in flags or \
       DryAdmissionDossierRiskFlag.PAPER_MODE_LAUNCH_RISK in flags or \
       DryAdmissionDossierRiskFlag.ORDER_CREATED_RISK in flags or \
       DryAdmissionDossierRiskFlag.MUTATION_DETECTED_RISK in flags:
...
print("Ingestion and eligibility created")
