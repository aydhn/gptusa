...
def test_phase160_handoff_package():
    ...
    assert package.package_valid == True
    assert package.read_only == True
    assert package.live_trading_enabled == False
    assert package.investment_advice == False
