...
from usa_signal_bot.provider_quality.provider_ranking_engine import rank_providers_for_symbol
from usa_signal_bot.provider_quality.score_explanation import score_explanation_safety_check
from usa_signal_bot.provider_quality.provider_quality_validation import validate_no_unsafe_provider_quality_fields
...
def test_ranking_engine():
    ...
    s1 = build_provider_selection_score("P1", "AAPL", "OHLCV", quality_score=None, trust_profile=None)
...
def test_validation():
    ...
    rep2 = validate_no_unsafe_provider_quality_fields({"network_used": False, "paper_state_mutated": False})
    assert rep2.valid
