from usa_signal_bot.feature_engine.core_indicators.phase117_models import FeatureFoundationIngestionResult, _dt

def test_models():
    ing = FeatureFoundationIngestionResult(
        ingestion_id="test", created_at_utc=_dt(), source_path=None, source_review_id=None, source_context_id=None,
    ...
    assert ing.feature_foundation_ready
