...
from usa_signal_bot.paper_safe_dossier.dossier_audit import create_paper_safe_dossier_audit_entry, PaperSafeDossierAuditParams
...
def test_paper_safe_dossier_reporting():
    ...
    audit = create_paper_safe_dossier_audit_entry(PaperSafeDossierAuditParams("Entity", "123", "ACTION", "Rationale"))
