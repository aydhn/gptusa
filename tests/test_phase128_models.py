from usa_signal_bot.regime_classification.labeling.phase128_models import RegimeFeatureEngineeringIngestionResult, create_regime_feature_engineering_ingestion_id
from usa_signal_bot.core.enums import RegimeLabelingStatus, RegimeLabelingDecision
...
def test_models():
    ...
    assert ingestion.ingestion_id.startswith("rfe_ingest_")
