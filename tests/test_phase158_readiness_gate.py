from usa_signal_bot.portfolio.risk_reporting.phase158_readiness_gate import (
    build_phase158_readiness_gate
)
...
from usa_signal_bot.portfolio.risk_reporting.phase158_handoff_package import build_phase158_handoff_package
from usa_signal_bot.portfolio.risk_reporting.portfolio_risk_safety_boundary import build_portfolio_risk_safety_boundary_result, build_portfolio_risk_safety_boundary_rules
...
def test_build_phase158_readiness_gate():
    ...
    assert gate.ready_for_phase158 is True
    assert gate.live_trading_enabled is False
    assert gate.actual_target_weights_produced is False
