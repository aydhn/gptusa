...
def run_benchmark(count, optimized=False):
    ...
    if optimized:
        ...
        def execute_optimized(plan, force=False):
            ...
            # Use ThreadPoolExecutor for I/O bound deletion, but don't do process_candidate
            # Let's just use original execute_candidate with ThreadPoolExecutor

            with concurrent.futures.ThreadPoolExecutor(max_workers=32) as pool:
                # We need to maintain the same object changes
                futures = []
