...
if "regime_final_closure" not in content and "def _parse_config" in content:
    ...
    content = content.replace(
        ...
        "from usa_signal_bot.core.config_schema import Config, RegimeFinalClosureConfig, Phase135ClosurePolicyConfig, Phase135ArtifactChainConfig, Phase135FreezeSealConfig, Phase135MLKickoffConfig, Phase135NotificationsConfig"
    )
